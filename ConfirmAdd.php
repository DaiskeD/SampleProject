...
if ( empty($_POST['Addition']) ) {
 echo "Warning, your supplies are empty, please go back! ";
...
$Adding = $_POST["Addition"];
$_SESSION['Addd'] = $Adding;
}
...
$row = $result->fetch_assoc();
        ...
        echo '<tr><td align="left">' .
			...
			echo '</tr>';
			echo '</table>';
			echo "Are you sure you would like to add " . $Adding . " To your Supplies?";
$conn->close();
?>
	<form action="AddSupplies.php" method = "POST">
